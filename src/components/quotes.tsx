...
const leQuotes: quote[] = [
  {
    message: "It's your life—but only if you make it so. The standards by which you live must be your own standards, your own values, your own convictions in regard to what is right and wrong, what is true and false, what is important and what is trivial.", 
  ...
  {
    message:"Much of my rebelliousness starts with indifference to what is urgently important to others.",
    author: 'Barbara Ehrenreich'
  }, 
  {
    message: "Fitting in is about assessing a situation and becoming who you need to be to be accepted. Belonging, on the other hand, doesn't require us to change who we are; it requires us to be who we are.", 
    author: "Brené Brown"
  }, 
  ...
  {
    message: "I know who I WAS when I got up this morning, but I think I must have been changed several times since then.", 
